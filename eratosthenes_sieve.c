// VAMOS IMPLEMENTAR EM C UM PROGRAMA QUE USA A PENEIRA DE ERASTÓTENES PARA
// CALCULAR TODOS OS NÚMEROS PRIMOS ATÉ UM DADO VALOR FORNECIDO PELO USUÁRIO
// COMPILAR ESTE PROGRAMA COM O COMANDO: gcc -o eratosthenes_sieve
// eratosthenes_sieve.c -lm
