...
/*
O ALGORITMO DE SOLOVAY-STRASSEN É BASEADO NA SEGUINTE PROPOSIÇÃO: PARA n INTEIRO NEGATIVO n É PRIMO
SE E SOMENTE a^((n-1)/2)= (a/n) mod(n) ONDE (a/n) DENOTA O SÍMBOLO DE LEGENDRE. 

TAL TESTE É A PRINCIPIO PROBABLÍSTICO, PORÉM TESTANDO-SE UM NÚMERO SUFICIENTE DE BASES TAL TESTE
PASSAR A SER DETERMINÍSTICO, CONDICIONADO A VERACIDADE DA HIPÓTESE DE RIEMANN.
