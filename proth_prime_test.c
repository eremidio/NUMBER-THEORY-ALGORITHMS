//VAMOS CRIAR UM PROGRAMA QUE IMPLMENTA O TESTE DE PRIMALIDADE PARA NÚMEROS DE PROTH
...
PARA NÚMEROS NESTA CATEGORIA, O TEOREMA DE PROTH GARANTE QUE ELE É PRIMO SE E SOMENTE SE: 2^((p-1)/2)= -1 mod(p).
...
/*Um número é denominado um resíduo quadrático a menos de uma congruência se existe um inteiro x tal que: x²= q mod(x).
Se não existir tal número o número em questão é dito um quadrado não residual.
Um teste heurístico probabilístico consite em usar os chamados símbolos de Legendre.
*/
...
//Para quadrados não residuais o teste é exato, caso contráio apenas probabilístico
