// VAMOS CRIAR UMA ROTINA PARA CALCULAR OS NÚMEROS DE BERNOULLI USANDO
// AFUNÇÃOZETA DE RIEMANN

/*
OS NÚMEROS D BERNOULLI PODE SER CALCULADOS USANDO-SE A FUNÇÃO ZETA DE RIEMANN
POR MEIO DA RELAÇÃO:
...
double
bernoulli_number_generator0 (int n)
{
  // Casos triviais
  if (n == 0)
    return 1.0;
