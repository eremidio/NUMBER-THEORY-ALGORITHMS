//VAMOS ESCREVER UM PROGRAMA QUEM IMPLMENTA AS ROTINAS DE EXPONENCIAÇÃO BINÁRIA MODULAR E EXPONENCIAL MODULAR PARA INTEIROS DE 128 BITS
...
//Variáveis locais
__int128_t result=1;
__int128_t i;//Variável de iteração
