...
//Restrição
  if(z2.norm()>z1.norm()) return gaussian_euclides_algorithm(z2, z1);
  ...
  //Procedimentos
    ...
    if(remainder.real==0 && remainder.imag==0) return z2;
    else return gaussian_euclides_algorithm(z2, remainder);
