...
/*
OS NÚMEROS DE BERNOULLI FORMAM UMA DAS SEQUÊNCIAS MAIS IMPORTANTES EM MATEMÁTICA APARECENDO EM DIVERSOS CONTEXTOS COMO NA EXPANSÃO ANALÍTICA DE CERTAS FUNÇÕES COMO A FUNÇÃO TANGENTE CIRCULAR E A TANGENTE HIPERBÓLICA, NA FÓRMULA DO TEOREMA DE
FAULHABER, EM DETERMINADAS EXPRESSÕES ENVOLVENDO A FUNÇÃO ZETA DE RIEMANN, ENTRE OUTROS.

VÁRIAS FÓRMULAS EXISTEM PARA CALCULAR ESTES NÚMEROS TANTO RECURSIVAMENTE, QUANTO EXPLICITAMENTE.
USAREMOS AQUI A CONVENÇÃO MAIS MODERNA NA QUAL B(1)=-1/2.
...
for(k=0; k<n; ++k){
bernoulli+=(bernoulli_number_generator2(k)*combination(n, k)/(n-k+1));
                  };
return (-1)*bernoulli;
                                         };
