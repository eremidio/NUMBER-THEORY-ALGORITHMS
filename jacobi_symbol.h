...
SIMPLES. PARA MAIORES INFORMAÇÕES: https://en.wikipedia.org/wiki/Jacobi_symbol


O SÍMBOLO DE JACOBI É UM CASO ESPECIAL CARACTÉRE DE DIRICHLET A MENOS DE UMA
RELAÇÃO DE CONGRUÊNCIA. PARA MAIORES INFORMAÇÕES:
...
// inteiros
int64_t
euclides_check (int64_t a, int64_t b)
{
  if (b == 0)
    return a;
  else
