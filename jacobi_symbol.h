...
OS SÍMBOLOS DE JACOBI SÃO CALCULADOS MULTIPLICANDO-SE OS REPECTIVOS SÍMBOLOS DE LEGENDRE DOS FATORES PRIMOS UM DADO NÚMERO ELEVADO AO SEU NÚMERO DE OCORRÊNCIA DE CADA FATOR NESTE NÚMERO. PARA NÚMEROS PRIMOS AMBOS DOS SÍMBOLOS SÃO IGUAIS.

UMA SÉRIE DE  RELAÇÕES RECURSIVAS PERMITE OBTER O SÍMBOLO DE JACOBI DE FORMA SIMPLES. UMA GENERALIZAÇÃO SIMPLES EXTENDE A DEFINIÇÃO PARA O CASO EM QUE a<0.
