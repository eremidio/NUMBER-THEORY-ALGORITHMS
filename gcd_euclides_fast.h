// VAMOS CRIAR UM PROGRAMA QUE IMPLEMENTA UM ALGORITMO DE EUCLIDES USANDO
// OPERADORES BITWISE

/*
O ALGORITMO DE EUCLIDES PODE SER OTIMIZADO BASEANDO-SE NAS SEGUINTES
PROPOSIÇÕES FACILMENTE DEMONSTRÁVEIS:
...
https://bjpcjp.github.io/pdfs/math/number-theory-ITA.pdf
...
// Usaremos a subtração via operadores bitwise bit_sub() disponível no arquivo
// arithmetic.h nesta implementação
int64_t
binary_gcd (int64_t a, int64_t b)
{
  // Procedimento
  // Caso trivial
  if (b == a)
