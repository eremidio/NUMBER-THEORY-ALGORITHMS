...
SÃO POLINÔMIOS E r(x) TEM GRAU (r-1). O TESTE SE REDUZ ENTÃO A TESTES SOBRE OS COEFICIENTES DE s(x). ALGUNS TESTES ADICIONAIS SÃO PERFORMADOS  ENVOLVENDO A ORDEM MULTIPLICATIVA DE n PARA DETECTAR A PRIMALIDADE DO NÚMERO EM QUESTÃO.
