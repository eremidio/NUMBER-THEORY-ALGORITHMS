// UM PROGRAMA PARA TESTAR ALGUMAS ROTINAS UTÉIS ENVOLVENDO NÚMEROS INTEIROS
// DISPONÍVEIS NO ARQUIVO divisibility.h COMPILAR ESTE PROGRAMA COM O COMANDO:
// gcc -o divisibility_test divisibility_test.c -lm
