...
/*
O MÉTODO DE MONTGOMERY É UMA VARIAÇÃO DO MÉTODO ORIGINAL DE FATORAÇÃO VIA CURVAS ELÍPTICAS PROPOSTO POR H. LENSTRA QUE USA AS CHAMADAS CURVAS DE MONTOGOMERY
...
int auto_setup;//Função usada para reiniciar o algoritmo
...
//Etapa 3: reiniciando o algoritmo com outra curva caso o algoritmo não encontre um fator primo no estágio anterior
reset1:
set_new_curve();
curve_number++;
...
//Etapa 4: executando o estágio 2 do algoritmo
step3:
second_stage();
if(selection>1 && selection!=number)
goto step4;
...
//Etapa 6: executando o estágio 1 do algoritmo
step4:
if(selection>1 && selection!=number){
calculate_factors();
print_result();
...
//Etapa 5: Encerrando o algortimo caso um fator não tenha sido encontrado noestágio 2 do algoritmo
end:
