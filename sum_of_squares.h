...
/*
A FUNÇÃO r(k,n) É UMA FUNÇÃO ARITMÉTICA QUE COMPUTA DE QUANTAS FORMAS DIFERENTES UM INTEIRO n PODE SER EXPRESSO COMO A SOMA DE k QUADRADOS PERFEITOS n=a(0)²+...+a(k)².
FÓRMULAS EXPLICÍTAS EXISTEM PARA ALGUNS CASOS PARTICULARES COMO k=2, 3, 4, 6, ENTRE OUTROS.

A FUNÇÃO r(k, n) CORRESPONDE AOS COEFICIENTES DA EXPANSÃO EM SÉRIE DE FOURIER DA k-ÉSIMA POTÊNCIA DA FUNÇÃO THETA DE JACOBI.

ALGUNS TEOREMAS IMPORTANTES DÃO CONDIÇÕES NECESSÁRIAS PARA QUE n SEJA EXPRESSO COMO A SOMA DE QUADRADOS PERFEITOS E/OU DETERMINAM DE QUANTAS FORMAS DIFERENTES ISSO PODE
SER FEITO. EM PARTICULAR:

TEOREMA DA SOMA: UM NÚMERO PODE SER EXPRESSO COMO A SOMA DE DOIS QUADRADOS n=a²+b², SE E SOMENTE SE EM SUA DECOMPOSIÇÃO EM FATORES PRIMOS NÃO HOUVER UM FATOR p^k COM p
PRIMO E k ÍMPAR.

TEOREMA DE LEGENDRE: UM NÚMERO PODE SER EXPRESSO COMO A SOMA DE TRÊS QUADRADOS n=a²+b²+c², SE E SOMENTE ELE NÃO FOR DA FORMA  n=(4^m)(8n+7) COM m, n INTEIROS.

TEOREMA DE LANGRANGE: TODO NÚMERO NATURAL n PODE EXPRESSO COMO A SOMA DE QUATRO QUADRADOS PERFEITOS n=a²+b²+c²+d².
...
printf("O número em questão não é expressável como a soma de dois quadrados perfeitos.\n");
return;
                                };
