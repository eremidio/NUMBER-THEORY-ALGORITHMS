// VAMOS CRIAR UM PROGRAMA PARA TESTAR AS ROTINAS CRIADAS NO HEADER
// mobius_function.h COMPILAR ESTE PROGRAMA COM O COMANDO: gcc -o
// mobius_function mobius_function.c -lm
