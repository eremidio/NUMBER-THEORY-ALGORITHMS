...
//CALCULANDO A MAIOR POTÊNCIA DO NÚMERO PRIMO MENOR QUE O VALOR QUE SERÁ EXPRESSO NESSA BASE
...
//CALCULANDO OS DÍGITOS DA EXPANSÃO P-ÁDICA DO MÓDULO DE UM NÚMERO NEGATIVO
do{
digits_array_size++;
...
//cout<<"Digito positivo: "<<positive_digits_array[digits_array_size-1]<<"\n";
...
//***************************************************************************************************************************
//FUNÇÃO QUE CALCULA A EXPANSÃO P-ÁDICA DE UM NÚMERO RACIONAL COM AS SEGUINTES CONDIÇÕES:
