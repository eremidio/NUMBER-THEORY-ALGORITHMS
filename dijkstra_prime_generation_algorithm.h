//VAMOS CRIAR UM PROGRAMA QUE IMPLMENTA ALGORITMO DE DJIKSTRA PARA GERA NÚMEROS PRIMOS

/*
O ALGORITMO DE DIJKSTRA É UMA VARIANTE DA PENEIRA DE ERATÓSTENES USADO PARA GERAR PRIMOS ATÉ UM DETERMINADO LIMITE.

O ALGORITMO USA UMA LISTA DE PARES ORDENADOS (p, p²) COM p PRIMO. POSSÍVEIS CANDIDATOS A NÚMEROS PRIMOS r SÃO COMPARADOS COM O MENOR DOS VALORES DE p² QUE É ENTÃO
ATUALIZADO p²->p²+p SE r≲p², CONDIÇÃO QUE GARANTE A PRIMALIDADE DE r, O PAR ORDENADO (r, r²) É ENTÃO ADICIONADO A LISTA. EM ESSÊNCIA ESTE ALGORITMO É UMA REELABORAÇÃO
DA PENEIRA DE ERATÓSTENES, PORÉM COM A VANTAGEM DE ECONOMIA DE ESPAÇO.

PARA MAIORES INFORMAÇÕES: https://wiki.tcl-lang.org/page/Dijkstra%27s+Prime+Algorithm
...
//*******************************************************************************************************************************************************************
//FUNÇÕES
//Função que dado um valor r checa se existe algum elemento na lista de pares ordenados (p, p²)
...
prime_pair_list=(struct prime_pair*)realloc(prime_pair_list, 2*sizeof(struct prime_pair));
...
array_size++;
prime_pair_list=(struct prime_pair*)realloc(prime_pair_list, array_size*sizeof(struct prime_pair));
