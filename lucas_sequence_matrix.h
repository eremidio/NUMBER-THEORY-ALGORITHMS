//VAMOS CRIAR UMPROGRAMA QUE IMPLEMENTA O CÁLCULO DE SEQUÊNCIAS DE LUCAS USANDO MATRIZES
...
TAIS RELAÇÕES PODEM SER ESCRITA EM NOTAÇÃO MATRICIAL SIMPLIFICADA:
