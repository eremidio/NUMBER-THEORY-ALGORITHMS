...
(ii) CASO  a E b SEJAM DIFERENTES DE 0, ENTÃO SUA NORMA DEVE SER UM PRIMO DA FORMA p = 1 (mod 4).
...
//********************************************************************************************************************************************************
//FUNÇÕES
//Função que testa a primlidade de um númeiro inteiro
