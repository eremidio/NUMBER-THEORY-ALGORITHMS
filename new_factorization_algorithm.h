...
O ALGORITMO É SIMILAR AO ALGORITMO DE STRASSEN-POLLARD: PARA b VARIANDO DE n^(1/2) A 2 OS 
PRODUTOS [b^(n) (mod (b-1)n)] (mod n) SÃO ACUMULADOS. TOMANDO-SE O mdc DO PRODUTO COM O 
NÚMERO A SER FATORADO, UM FATOR PRIMO DO NÚMERO EM QUESTÃO É REVELADO. A COMPLEXIDADE DO
ALGORITMO É LIMITADA PELO MENOR FATOR PRIMO DO NÚMERO EM QUESTÃO.

TEMPO DE EXECUÇÃO RAZOÁVEIS SÃO OBTIDOS NO TESTE COM SEMIPRIMOS DA ORDEM DE 50 BITS. O
ALGORITMO É ÚTIL PARA REMOVER PEQUENOS FATORES PRIMOS (DA ORDEM DE 10^8) DE INTEIROS COMPOSTOS.
