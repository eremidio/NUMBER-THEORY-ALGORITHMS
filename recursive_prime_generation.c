//VAMOS CRIAR PROGRAMA PARA TESTAR AS RORINAS CRIADAS NO ARQUIVO recursive_prime_generation.h
//COMPILAR ESTE PROGRAMA COM COMANDO: gcc -o recursive_prime_generation recursive_prime_generation.c
