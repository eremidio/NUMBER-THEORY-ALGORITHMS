...
/*
SEJA UM POLINÔMIO f(x) DEFINIDO EM UM CORPO FINITO DO TIPO 1, INTEIROS A MENOS DE UMA CONGRUẼNCIA.
DE GRANDE INTERESSE TEÓRICO É O ESTUDO DE SOLUÇÕES DA EQUAÇÃO DIOFANTINA f(x)=0 (mod n).

O SEGUINTE RESULTADO É DE INTERESSE PRÁTICO:

LEMA DE HENSEL: SE UM POLINÔMIO f(x) POSSUI UMA SOLUÇÃO EM F(p), ISTO É, f(x)=0 (mod p). ENTÃO EXISTE UMA SOLUÇÃO PARA QUALQUER
POTÊNCIA DE p, ISTO É, UMA SOLUÇÃO PARA f(x)=0 (mod p^k) COM k INTEIRO MAIOR QUE 1. ESPECIFICAMENTE SE f(r)=0 (mod p^k) E
f'(x)≠0 (mod p), ENTÃO EXISTE UM m INTEIRO TAL QUE f(s)=0 (mod p^(k+m)) E s=r (mod p^k) s É ÚNICO A MENOS DE UMA CONGRUÊNCIA
mod(p^(m+k)).

TAL TEOREMA É PARTICULARMENTE ÚTIL PARA ENCONTRAR RAÍZES DE UM POLINÔMIO A MENOS DE UMA CONGRUÊNCIA MÓDULO UMA POTÊNCIA
DE UM NÚMERO PRIMO, COMBINANDO ESTE RESULTADO COM O TEOREMA DE RESÍDUO CHINÊS CONGRUÊNCIAS MÓDULO NÚMEROS COMPOSTOS PODEM SER
FACILMENTE COMPUTADAS.
