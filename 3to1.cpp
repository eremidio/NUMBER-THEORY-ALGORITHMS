...
cout<<"Esta conjectura postula que uma sequência de números inteiros definidos pela regras x(n+1)=x(n)/2 se x(n) for par e x(n)=3x(n)+1 se x(n) for ímpar, sempre converge para o loop composto pelos elementos 4,2,1 (1*3+1=4 -> 4/2=2 -> 2/2=1 -> 1*3+1=4 -> ...)\n\n";
