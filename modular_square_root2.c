// VAMOS CRIAR UM PROGRAMA QUE CALCULA RAÍZES QUADRADAS AMENOS DE UMA RELAÇÃO
// DE CONGRUÊNCIA USANDO TENTATIVA E ERRO COMPILAR ESTE PROGRAMA COM: gcc
// modular_square_root2  modular_square_root2.c

/*
UM NÚMERO r É DEFINIDO COMO A RAÍZ QUADRADA DE UM NÚMERO n A MENOS DE UMA
CONGRUÊNCIA ENVOLVENDO UM PRIMO p SE r²= n (mod p).
*/
...
// FUNÇÕES
uint64_t
modular_sqrt (uint64_t n, uint64_t p)
{
  // Variáveis locais
  uint64_t i;
