...
ADMITINDO QUE TAL RELAÇÃO SEJA VÁLIDA PARA NÚMEROS REAIS. PODE-SE EXTENDER A DEFINIÇÃO DE NÚMEROS HARMÔNICOS PARA NÚMEROS 
REAIS E COMPLEXOS.
...
OS NÚMEROS HARMÔNICOS POSSUEM RELAÇÃO DIRETA COM FUNÇÕES IMPORTANTES EM MATEMÁTICA COMO A FUNÇÃO DIGAMA (DERIVADA DO
LOGARITMO DA FUNÇÃO GAMA) E A FUNÇÃO ZETA DE RIEMANN (DE FATO, NÚMEROS HARMÔNICOS SÃO SOMAS PARCIAIS DA SÉRIE HARMÔNICA QUE É
NUMERICAMENTE IGUAL A ζ(1)).
