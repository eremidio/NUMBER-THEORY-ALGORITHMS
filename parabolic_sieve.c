//VAMOS CRIAR UM PROGRAMA QUE IMPLEMENTA O ALGORITMO DA PENEIRA QUADRÁTICA (PARABÓLICIA) PARA COMPUTAR NÚMEROS PRIMOS
...
INTERSECÇÃO DAS RETAS CONECTANDOS DOIS PONTOS UM ACIMA DO EIXO x (y POSITIVO) E OUTRO ABAIXO DO EIXO x (y NEGATIVO) COM O EIXO x
TEM COORDENADAS (n, 0) COM n INTEIRO.
