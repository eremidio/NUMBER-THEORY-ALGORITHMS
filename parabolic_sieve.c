// VAMOS CRIAR UM PROGRAMA QUE IMPLEMENTA O ALGORITMO DA PENEIRA QUADRÁTICA
// (PARABÓLICIA) PARA COMPUTAR NÚMEROS PRIMOS COMPILAR ESTE PROGRAMA COM O
// COMANDO: clang -o parabolic_sieve parabolic_sieve.c

/*
O ALGORITMO DA PENEIRA QUADRÁTICA (PARABÓLICA) USA A CURVA DE EQUAÇÃO x=y²,
PARA GERA NÚMEROS PRIMOS. PONTOS NESTA CURVA TEM AS COORDENADAS (y², y) OU (y²,
-y). SELECIONANDO OS PONTOS DA CURVA COM COORDENADAS INTEIRAS É POSSÍVEL
MOSTRAR QUE OS PONTOS DE INTERSECÇÃO DAS RETAS CONECTANDOS DOIS PONTOS UM ACIMA
DO EIXO x (y POSITIVO) E OUTRO ABAIXO DO EIXO x (y NEGATIVO) COM O EIXO x TEM
COORDENADAS (n, 0) COM n INTEIRO.
