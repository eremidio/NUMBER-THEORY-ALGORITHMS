...
//COMPILAR ESTE PROGRAMA COM O COMANDO: gcc -o quadratic_frobenius_primality_test_polynomial_version quadratic_frobenius_primality_test_polynomial_version.c -O2 -lm
...
int main(){
  ...
  //Procedimentos
    ...
    if(quadratic_frobenius_test(number)==true)
