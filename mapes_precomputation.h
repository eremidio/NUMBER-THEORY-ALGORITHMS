...
void mapes_precomputation(){
  ...
  //Variáveis locais
  FILE* mapes_file2, *mapes_file3, *mapes_file4, *mapes_file5, *mapes_file6, *mapes_file7, *mapes_file8, *mapes_file9, *mapes_file10, *mapes_file20;
  ...
  //Procedimenstos
    ...
    mapes_file20=fopen("mapes20.txt", "r");
