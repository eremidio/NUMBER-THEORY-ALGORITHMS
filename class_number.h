...
POR EXEMPLO: NO CORPO ALGÉBRICO Q(√-5) COMPOSTO POR NÚMEROS DA FORMA a+(√-5)b, COM a E b RACIONAIS O NÚMERO 6 (a=6, b=0) ADMITE DUAS FORMAS DISTINTAS DE DECOMPOSIÇÃO EM FATORES PRIMOS 6=(2+(√-5)0)(3+(√-5)0) E 6=(1+(√-5)1)(1-(√-5)1).
...
Δ=b²-4ac. POR EXEMPLO: Q(√-23) TEMOS AS TRIPLAS (a, b, c)=(1, 1, 6); (2, -1, 3); (2, 1, 3) DE MODO QUE h(-23)=3.
