...
PARA DETECTAR SE UM NÚMERO É UM NÚMERO DE CARMICHAEL PODE-SE TESTAR PARA VALORES DE ATÉ n SE AS IDENTIDADES ACIMAS NA DEFINIÇÃO
SÃO SATISFEITAS. OUTRA POSSIBILIDADE É USAR O TEOREMA DE KORSELTS QUE AFIRMA QUE: UM NÚMERO n É UM NÚMERO DE CARMICHAEL SE E SOMENTE SE ELE NÃO TIVER FATORES PRIMOS QUADRÁTICOS E PARA TODO FATOR PRIMO p (n-1) DIVIDE (p-1).
