//VAMOS CRIAR UM PROGRAMA QUE APROXIMA O VALOR DO N-ÉSIMO NÚMERO PRIMO E DA FUNÇÃO DE CONTAGEM DE PRIMOS

/*
SUBJACENTE A HIPÓTESE DE RIEMANN, VÁRIAS FÓRMULAS PODEM SER DERIVADAS PARA ESTIMAR 
A FUNÇÃO π(x) DE CONTAGEM DE NÚMEROS PRIMOS E O VALOR p(n) DO n-ÉSIMO NÚMERO
PRIMO.
...
//***********************************************************************************************************
//CABEÇALHO
#ifndef PRIME_NUMBER_ESTIMATION_H
#define PRIME_NUMBER_ESTIMATION_H
#include <math.h>
#include <stdbool.h>
#include <stdint.h>
#include <assert.h>
