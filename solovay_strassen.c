//VAMOS CRIAR UM PROGRAMA QUE IMPLMENTA O TESTE DE SOLOVAY STRASSEN PARA CHECAR A PRIMALIDADE DE UM NÚMERO
//COMPILAR ESTE PROGRAMA COM O COMANDO: gcc -o solovay_strassen solovay_strassen.c
...
bool solovay_strassen(int64_t n, int k){
//Variáveis locais
int i;
int p_results=0;
