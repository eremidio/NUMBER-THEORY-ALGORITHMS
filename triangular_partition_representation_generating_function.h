//VAMOS CRIAR UM PROGRAMA QUE IMPLEMENTA UMA ROTINA PARA COMPUTAR O NÚMERO DE PARTÇÕES TRIANGULARES DE UM INTEIRO USANDO FUNÇÕES GERADORAS 
...
TRIANGULARES DIFERENTES (DIFERENTES ORDENS CONTAM COMO PARTÇÕES DIFERENTES). UM NÚMERO TRIANGULAR É UM INTEIRO DA FORMA t={n(n+1)/2}.
