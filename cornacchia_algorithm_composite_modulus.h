...
void cornacchia_algorithm_composite_modulus(int64_t, int64_t, int64_t*, int64_t*);

//*********************************************************************************************************************************
//FUNÇÕES
//Função que implementauma variante do algoritmo de  Connarchia generalizado módulo números compostos
void cornacchia_algorithm_composite_modulus(int64_t d, int64_t m, int64_t* x, int64_t* y){
