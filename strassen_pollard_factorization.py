#VAMOS CRIAR UM PROGRAMA QUE IMPLMENTA O ALGORITMO DE STRASSEN PARA FATORAR NÚMEROS INTEIROS
'''
O ALGORITMO DE STRASSEN (POLLARD) É O ALGORITMO MAIS RÁPIDO PARA FATORAR NÚMEROS INTEIROS CUJA COMPLEXIDADE É TEMPO DE EXECUÇÃO É RIGOROSAMENTE DETERMINADO
O(n^(1/4)log(n)).
