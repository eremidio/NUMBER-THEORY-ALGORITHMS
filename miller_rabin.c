...
/*
O TESTE DE MILLE RABIN É UM TESTE DA PRIMALIDADE DE UM NÚMERO PRIMO QUE GENERALIZA O TESTE DE PRIMALIDADE DE FERMAT.
ELE É FUNDAMENTADO NO CHAMADO PEQUENO TEOREMA DE FERMA QUE AFIRMA QUE PARA UM DADO NÚMERO PRIMO p E UM INTEIRO a COPRIMO COM ELE a^(p-1) = 1(mod p).
