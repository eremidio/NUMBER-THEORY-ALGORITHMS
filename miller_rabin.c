...
// COMANDO: gcc -o miller_rabin miller_rabin.c
/*
O TESTE DE MILLE RABIN É UM TESTE DA PRIMALIDADE DE UM NÚMERO INTEIRO QUE
GENERALIZA O TESTE DE PRIMALIDADE DE FERMAT. ELE É FUNDAMENTADO NO CHAMADO
PEQUENO TEOREMA DE FERMAT QUE AFIRMA QUE PARA UM DADO NÚMERO PRIMO p E UM
INTEIRO a COPRIMO COM ELE a^(p-1) = 1(mod p).

O ALGORITMO FUNCIONA DA SEGUINTE FORMA:
1. DADO UM NÚMERO n A SER TESTADO, TESTA=SE SE O PNÚMERO EM QUESTÃO É PAR (CASO
TRIVIAL).
2. NÚMEROS ÍMPARES PODEM SER ESCRITOS NA FORMA: n-1=2^(s)d, COM s>0 E d ÍMPAR.
3. ESCOLHE-SE ALEATORIAMENTE UM NÚMERO INTEIRO a TAL QUE a É COPRIMO COM n. a É
UMA TESTEMUNHA DA PRIMALIADE DE n.
4. n É UM POSSÍVEL PRIMO SE a^(d)= 1 mod(n) OU a^(2^(r)d)= -1 mod(n), PARA
ALGUM r NO INTERVALO 0, 1, 2,..., s-1
*/
...
bool
miller_rabin_test (uint64_t n, int k)
{
  // Variáveis locais
  int i;
  int p_results = 0;
