...
// COMPILAR ESTE PROGRAMA COM A FUNÇÃO: gcc -o prime_counting_function
// prime_counting_function.c -lm
...
// Eratóstenes
unsigned long long
prime_counting_function (double x)
{
