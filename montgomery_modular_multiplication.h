...
TIPICAMENTE O ALGORITMO EXIGE QUE UM INPUT SEJA ESCRITO EM FORMA DE MONTGOMERY E O RESULTADO FINAL SEJA RECONVERTIDO PARA A REPRESENTAÇÃO USUAL, PORÉM AO EVITAR O CÁLCULO
