//VAMOS CRIAR UM PROGRAMA QUE TESTA AS ROTINAS DEFINIDAS NO HEADER modular_square_root.h
//COMPILAR ESTE PROGRAMA COM O COMANDO: gcc -o modular_square_root modular_square_root.c    
