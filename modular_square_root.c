...
//COMPILAR ESTE PROGRAMA COM: gcc -o modular_square_root  modular_square_root.c -lm


/*
UM NÚMERO r É DEFINIDO COMO A RAÍZ QUADRADA DE UM NÚMERO n A MENOS DE UMA CONGRUÊNCIA ENVOLVENDO UM PRIMO p SE r²= n (mod p).
CLASSES RESIDUAIS QUADRÁTICAS SÃO IMPORTANTES NA MAIORIA DOS ALGORITMOS EM TEORIA DOS NÚMEROS.
*/
