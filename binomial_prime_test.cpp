//VAMOS CRIAR UM PROGRAMA QUE IMPLEMENTA O TESTE BINOMIAL PARA TESTAR SE UM NÚMERO É PRIMO OU NÃO
//COMPILAR ESTE PROGRAMA COM O COMANDO:g++ -o binomial_prime_test binomial_prime_test.cpp
...
NESTA IMPLEMENTAÇÃO USAREMOS CONVOLUÇÃO PARA CALCULAR OS TERMOS DA EXPANSÃO EM POTÊNCIAS DE n
{1,1}x{1,1}={1x1, 1x1+1x1, 1x1}={1,2,1}
{1,2,1}x{1,1}={1x1, 1x1+2x1, 2x1+1x1, 1x1}={1, 3, 3, 1}
{1, 3, 3, 1}x{1,1}={1x1, 1x1+3x1, 3x1+3x1, 3x1+1x1, 1x1}={1, 4, 6, 4, 1}

ALGUNS TESTE PRELIMINARES PODEM SER USADOS PARA TESTAR A PRIMALIDADE DOS NÚMEROS DE ANTEMÃO.
E OUTRAS OUTRAS OTIMIZAÇÕES COMO NÃO CALCULAR TODOS OS TERMOS DA EXPANSÃO PODEM SER FEITOS.
(POR SIMETRIA APENAS METADE DOS COEFICIENTES+2 NECESSITAM SER CALCULADOS, POIS A CADA ITERAÇÃO 1 ELEMENTO A MAIS NECESSITA SER CALCULADO.)


ESTE ALGORITMO NÃO FOI TESTADO PARA EFICIÊNCIA.
ESTIMA-SE PORÉM UM COMPLEXIDADE PARA UM DADO INPUT n DA ORDEM O(n²) E REQUER UM ESPAÇO AUXILIAR O(n).
É INSPIRADO NO TESTE DE PRIMALIDADE AKS.
