// VAMOS CRIAR UM PROGRAMA QUE IMPLEMENTA O ALGORITMO DE FERMAT PARA TESTAR SE
// UM NÚMERO É PRIMOU NÃO COMPILAR ESTE PROGRAMA COM O COMANDO: gcc -o
// fermat_prime_test fermat_prime_test.c -lm

/*

O TESTE DE FERMAT É UM TESTE DA PRIMALIDADE DE UM NÚMERO INTEIRO.
ELE É FUNDAMENTADO NO CHAMADO PEQUENO TEOREMA DE FERMAT QUE AFIRMA QUE PARA UM
DADO NÚMERO PRIMO p E UM INTEIRO a COPRIMO COM ELE a^(p-1) = 1(mod p).

O ALGORITMO FUNCIONA DA SEGUINTE FORMA:
1. PARA UM DADO NÚMERO n A SER TESTADO, ESCOLHE-SE UM NÚMERO a COPRIMO COM n.
2. O TEOREMA DE FERMAT É APLICADO AO PAR (a, n) E EM CASO AFIRMATIVO O NÚMERO
EM QUESTÃO É POTENCIALMENTE UM PRIMO.
3. REPETINDO-SE O TESTE UM NÚMERO SUFICIENTEMENTE GRANDE DE VEZES, UMA PRECISÃO
MAIOR É GARANTIDA NO TESTE.
