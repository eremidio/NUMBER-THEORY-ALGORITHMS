...
/*
OS INTEIROS DE EISENSTEIN (TAMBÉM CONHECIDOS COMO INTEIROS DE EULER)SÃO NÚMEROS COMPLEXOS DA FORMA z=a+bω, ΟΝDE ω=e^(i2π/3)=(-1+i√3)/2.
ω É UMA RAÍZ CÚBICA PRIMITIVA (NÃO REAL) DA UNIDADE. OS INTEIROS DE EISENSTEIN FORMAM UM ANEL COMUTATIVO DE INTEIROS ALGÉBRICOS NO
CORPO ALGÉBRICO Q(ω) O TERCEIRO CORPO CICLOTÔMICO. INTEIROS DE EISENSTEIN SÃO SOLUÇÕES DO POLINÔMIO P(x)=x²-(2a-b)x+(a²-ab+b²), EM
PARTICULAR ω²+ω+1=0. O GRUPO DE UNIDADES NESTE ANEL É O GRUPO CÍCLICO FORMADO POR: {1, -1, ω, -ω, ω², -ω²}.

SEJA ω* O COMPLEXO CONJUGADO DE ω NO CORPO DOS NÚMEROS COMPLEXOS, ENTÃO ω*ω=|ω|²=1 E ω²=ω*. DESTA RELAÇÕES SEGUEM-SE AS SEGUINTES
FÓRMULAS PARA AS OPERAÇÕES USUAIS, COM w=c+dω: 
...
O DOMÍNIO DOS INTEIROS DE EISENSTEIN FORMAM UM DOMÍNIO DE FATORAÇÃO ÚNICA. PRIMOS DE EISENSTEIN SÃO NÚMEROS PRIMOS (INTEIROS RACIONAIS)
DA FORMA p=2 (mod 3). PARA PRIMOS DA FORMA p=1 (mod 3), p CORRESPONDE A NORMA DE UM INTEIRO DE EISENSTEIN, DE FORMA QUE
p=(x²-xy+y²)=(x+ωy)((x-y)-yω), (x+ωy) E ((x-y)-yω) SÃO CONSIDERADOS PRIMOS DE EISENSTEIN TAMBÉM. OS INTEIROS DE EISENSTEIN FORMAM UM
DOMÍNIO EUCLIDIANO.
