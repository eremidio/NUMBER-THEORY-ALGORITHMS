// VAMOS ESCREVER UM PROGRAMA QUEM IMPLMENTA AS ROTINAS DE EXPONENCIAÇÃO
// BINÁRIA MODULAR E EXPONENCIAL MODULAR
...
EXPONENCIAL. POR EXEMPLO: 13 = 8+4+1 = 1.2³+1.2²+0.2¹+1.2⁰ --> 1101 a¹³=
a⁸a⁴a¹= ((a²)²)².(a²)².a =(a⁴)².(a²)².a
...
//***********************************************************************************************************************
// CABEÇALHO (usaremos apenas headers básicos de C para maior compatibilidade
// com C++)
...
uint64_t
mod_pow (uint64_t a, uint64_t b, uint64_t n)
{
  // Variáveis locais
  uint64_t result = 1;
...
POIS: 1º SHIFT: 01100 QUE É 12 (0+8+4+0+0) EM BINÁRIO 2º SHIFT: 00110 QUE É 12
(0+0+4+2+0) EM BINÁRIO

A PARIDADE DO MENOR BIT É TESTADA COM O OPERADOR and '&', QUE SATIFAZ AS
RELAÇÕES: 0 & 0 = 0 1 & 0 = 0 0 & 1 = 0 1 & 1 = 1

O NÚMERO 1 EM BINÁRIO É ...0001, DE FORMA QUE AO FAZER n & 1, TODOS OS BITS DE
n SÃO ZERADOS EXCETO POSSIVELMENTE O ÚLTIMO
*/
uint64_t
bin_pow (uint64_t a, uint64_t b)
{
  // Variáveis locais
  uint64_t result = 1;
  // Procedimentos
...
//***********************************************************************************************************************
// TÉCNICA MISTA DE EXPONENCIAÇÃO: EXPONENCIAÇÃO BINÁRIA COMBINADA COM
// EXPONENCIAÇÃO MODULAR
uint64_t
mod_bin_pow (uint64_t a, uint64_t b, uint64_t n)
{
  // Variáveis locais
  uint64_t result = 1;
  // Procedimentos
